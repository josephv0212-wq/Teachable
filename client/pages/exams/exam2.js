...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      'an offense disrupts the public peace',
  ...
  {
    question:
      'In the Use of Force Model, the response to resistance includes presence, verbal commands, ____________, non-lethal weapons, and lethal force.',
        ...
        <div className="max-w-4xl mx-auto">
          <div className="card mb-6">
            ...
            <p className="text-gray-600">
              Instructions: Read each question carefully and circle the correct answer for each question.
            </p>
          </div>
